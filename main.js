...
async function init() {
  ...
  const model = await loader.loadAsync(`https://rawcdn.githack.com/keigo9/wolf-animation/6cc924ce464a5bd2c7ce81a001826b10c96d8fe5/assets/wolf/scene.gltf`); // GLTFファイルをURLで指定する
